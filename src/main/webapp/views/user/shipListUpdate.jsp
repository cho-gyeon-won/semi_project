...
<body>
  ...
  <%@ page import="com.project.user.vo.User, com.project.user.vo.ShipList, java.util.*"%>
                    ...
                    <div class="title-left">
                        ...
                        if (ship != null && !ship.isEmpty()) {
                            for (int i = 0; i < ship.size(); i++) {
                                ...
                                %>
                    <form action="/ship/shipListUpdateEnd" method="post" name="updateList_form">
                    <input type="hidden" name="user_no" id="user_no" value="<%= user.getUser_no()%>">
					<input type="hidden" class="form-control"  name="ship_no" id="ship_no" value="<%= shipItem.getShip_no() %>">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="ship_alias" id="ship_alias" value="<%= shipItem.getShip_alias() %>">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="ship_name" id="ship_name" value="<%= shipItem.getShip_name() %>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="phone_number" id="phone_number" value="<%= shipItem.getShip_phone() %>">
                            <div class="invalid-feedback"> Please enter your phone_number. </div>
                        </div>

                        <div class="mb-3">
                            <label for="address_kakao">배송 받는 분 주소</label>
                            <input type="text" onclick="address_click()" class="form-control" name="address_kakao" id="address_kakao" value="<%= shipItem.getShip_address1() %>" readonly>
                            <div class="invalid-feedback"> Please enter a valid email address for shipping updates. </div>
                            <label for="address_detail">상세 주소</label>
                            <input type="text" class="form-control" name="address_detail" id="address_detail" value="<%= shipItem.getShip_address2() %>">
                            <div class="invalid-feedback"> Please enter a valid email address for shipping updates. </div>
                        </div>
                        ...
                        <input type="button" value="수정 완료" onclick="updateList();" class="custom-button">
                        </div><br>
                    </form>
                    <script>
                        function updateList() {
