package com.gn.product_admin.vo;

import java.time.LocalDateTime;

import com.gn.common.Paging;

public class Product_admin extends Paging{
	private int prod_no;
	private int cate_no;
	...
	public Product_admin(int prod_no, int cate_no, String prod_name, int prod_price, String prod_info,
			int prod_inventory, int sellCount, LocalDateTime prod_regDate, String prod_status, String prod_enroll_image,
			String pord_revise_image) {
		super();
		...
		this.prod_revise_image = pord_revise_image;
	}
	...
	public void setProd_revise_image(String pord_revise_image) {
		this.prod_revise_image = pord_revise_image;
	}
	...
	public String toString() {
		return "product_admin [prod_no=" + prod_no + ", cate_no=" + cate_no + ", prod_name=" + prod_name
				+ ", prod_price=" + prod_price + ", prod_info=" + prod_info + ", prod_inventory=" + prod_inventory
				+ ", sellCount=" + sellCount + ", prod_regDate=" + prod_regDate + ", prod_status=" + prod_status
				+ ", prod_enroll_image=" + prod_enroll_image + ", prod_revise_image=" + prod_revise_image + "]";
	}
}
